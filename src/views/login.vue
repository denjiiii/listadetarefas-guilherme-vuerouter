<template>
    <v-container fill-height fluid text-center>
        ...
        <v-row class="elavation-3 mx-auto">
            <v-col cols="auto">
                <v-img max-height="300" max-width="300" src="@/assets/images/macaco.jpg"></v-img>
            </v-col>
            <v-col>
                <v-form>
                    ...
                    <v-btn class="ml-3" color="warning" @click="reset" >Cancelar</v-btn>
                </v-form>
            </v-col>
        </v-row>
        </v-container>
        <v-snackbar color="red" v-model="errorLogin" danger multline timeout="2000">Usuário ou senha, inexistentes!
